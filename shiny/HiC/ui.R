...
sidebar = dashboardSidebar( 
    ...
    sidebarMenu(
        ...
        menuItem("Gene Vector", tabName = "download", icon = icon("download"))
        ...
        tabItem(
            ...
            box(
                ...
                column(
                    ...
                    br(),
                    div(paste("All genome-wide Hi-C aggregate dataset for a",
                              "species/resolution combination is available"),
                              a("here", href="http://labshare.cshl.edu/shares/gillislab/resource/HiC/"),
                              paste(". The downloaded file is", "in "),
            ...
            box(
                ...
                column(
                    ...
                    br(),
                    div(paste("Obtain the contacts of a gene with the entire genome",
                              "for various species/resolution combination under the Gene Vector tab."),
			paste("The downloaded vector is a"),
                              a("BED", href="https://genome.ucsc.edu/FAQ/FAQformat.html#format1.8"),
                              paste("file where the coloumns are chrom chromStart chromEnd contact_frequency. This file can be loaded in"),
                        a("UCSC genome browser", href="https://genome.ucsc.edu/cgi-bin/hgCustom?hgsid=1273859377_xuVHuoAjg9KAaLrvlqC9sVNt9le1&clade=insect&org=0&db=0&hgct_do_add=1"),
                        paste("as a custom track")),
                    ...
                    p(
                        ...
                        Ruchi Lohia, Nathan Fox, and Jesse Gillis<br/> <b>A global high-density chromatin interaction network reveals functional long-range and trans-chromosomal relationships</b>, 
                        <i>BioRxiv</i>, March 27 2022,<br/> <a href="https://www.biorxiv.org/content/10.1101/2022.03.24.485503v1.full" target="_blank">paper link</a>'
                        )
                    ),
