...
function(request){
    ...
    sidebar = dashboardSidebar(
        ...
        sidebarMenu(
            ...
            menuItem('Project',tabName = 'project',icon = icon('sitemap')),
            ...
            tabItem(tabName = 'query',
                fluidPage(theme =shinythemes::shinytheme("spacelab"),
                    box(    width=NULL, title = 'FAIRit-BRAIN',
                        fluidRow(
                            column(width = 9,
                                "FAIRit-BRAIN aims to make single-cell RNAseq data more FAIR (Findable Accessible Interoperable Reusable).",br(),
