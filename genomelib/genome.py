...
from genomelib.biomart import get_mapping_df
...
def index_annotations(annot_dict, tg_map ):
    ...
    for chr in annot_dict.keys():
        ...
        logging.debug(f'added {len(gene_dict)} genes, handling transcripts... ')
        for sf in chr_sr.features:
            try:
                # handle TRANSCRIPTS
